...
import 'package:iot9647/home_controller.dart';
import 'package:iot9647/models/TyrePsi.dart';
import 'package:iot9647/presentation/arduino_bottom_navigation_bar.dart';
import 'package:iot9647/screens/components/battery_status.dart';
import 'package:iot9647/screens/components/door_lock.dart';
import 'package:iot9647/screens/components/temp_details.dart';
import 'package:iot9647/screens/components/tyre_psi_card.dart';
import 'package:iot9647/screens/components/tyres.dart';
        ...
        builder: (context, _) {
          return Scaffold(
            appBar: AppBar(
              ...
              title: const Text('00009647'),
            ),
            bottomNavigationBar: ArduinoBottomNavigationBar(
              onTap: (index) {
                if (index == 1)
